...
It may be easiest to define what a grant is by what it is not:
...
* A grant is not an **investement** — When someone invests (purchases equity), they own part of your business. 

A grant is when something of value (usually money) is transferred to another party (you) for a specific purpose or particular use (what you applied to do). 


### Funding Sources
*Where do grants come from?*  
Generally, grants come from three common sources:* **Foundations** — A non-profit, charitable organization that award grants to support specific activities that fullfills their mission.	* Examples:
		...
		* [The Guggenheim Foundation](https://www.gf.org/about/fellowship/)* **Corporations** — A corporation may dedicate a portion of its profits via a subsidiary non-profit to support specific activities.	* Examples: 
		...
		* [Mozilla Foundation](https://foundation.mozilla.org/en/)* **Government** — Tax dollars are allocated by legislatures for specific purposes, which are awarded as grants by government agencies.	* Examples: 
...
*Do I need to form a non-profit to get grants?*
